...
class particle:
	"""
	This is a class defining a single particle found by Trackpy
		...
		Attribures:
			...
			polyline (NumPy polyline): The order 3 polynomial representing the particle's position.

			coords (list of tuples): The list of a particle's position and frame using the tuple (x (double), y (double), frame (int), error (double)).
			vel (list of tuples): The list of a particle's velocity and frame using the tuple (x (double), y (double), frame (int), error (double)).
			accel (list of tuples): The list of a particle's acceleration and frame using the tuple (x (double), y (double), frame (int), error (double)).
			jerk (list of tuples): The list of a particle's jerk and frame using the tuple (x (double), y (double), frame (int), error (double)).
